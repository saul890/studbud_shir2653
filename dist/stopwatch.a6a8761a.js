...
})({"9C2Kx":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "29fe6b7ea6a8761a";
"use strict";
...
},{}],"cDi7A":[function(require,module,exports) {
class State {
...
class Stopwatch {
    ...
    handleClickStart() {
        if (this.state.startTimestamp) // Prevent multi clicks on start
        return;
        this.setState({
    ...
    render() {
        const { difference: difference1  } = this.state;
        const hundredths = (difference1 ? Math.floor(difference1.getMilliseconds() / 10) : 0).toString().padStart(2, "0");
        const seconds = (difference1 ? Math.floor(difference1.getSeconds()) : 0).toString().padStart(2, "0");
        const minutes = (difference1 ? Math.floor(difference1.getMinutes()) : 0).toString().padStart(2, "0");
        // Render screen
...
},{}]},["9C2Kx","cDi7A"], "cDi7A", "parcelRequire48b2")

//# sourceMappingURL=stopwatch.a6a8761a.js.map
