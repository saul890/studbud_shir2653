...
function renderDefine(define) {
    ...
    for(i = 0; i < define.meanings[0].synonyms.length; i++)synonymList.push(define.meanings[0].synonyms[i]);
...
//# sourceMappingURL=dictionary.a903ddef.js.map
